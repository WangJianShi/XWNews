...
#import "XWLoadingView.h"
#import <Masonry.h>

@interface XWLoadingView ()
...
-(void)initSubView{
    self.frame=CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height-64-44-49);
